...
export default function CyfDashboardPage() {
  ...
  return (
    <div className="space-y-4">
      <div>
        <h1 className="text-2xl font-semibold tracking-tight">CYF Dashboard</h1>
        <p className="text-muted-foreground">Youth-focused overview.</p>
      </div>
