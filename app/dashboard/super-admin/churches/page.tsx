  ...
  return (
    <div className="space-y-4">
      <div>
        ...
        <p className="text-muted-foreground">All churches in the system.</p>
      </div>
              ...
              {loading ? (
                ...
                items.map((row, idx) => (
                  <TableRow key={(row.id as string | number | undefined) ?? idx}>
                    ...
                    <TableCell>
                      {(row.region_id as string | number | undefined) ??
                        ((row.region as AnyRecord | undefined)?.name as string | undefined) ??
                        "—"}
                    </TableCell>
                  </TableRow>
                ))
